...
$(document).ready(function(){
    $(window).scroll(function(){
        ...
        console.log("enl: " + $('.enlarge-wrapper').height());

        // if ($('.enlarge-wrapper').height() > 0.95 * $(window).height()) {
        //     var size = parseInt($('#big-text').css('font-size')) - 1;
        //     $('.big-text').css('font-size', size);
        // }
    });
});
